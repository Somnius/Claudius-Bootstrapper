...
| **Custom** | Preset or user URL | API key (Bearer) | Presets: **Alibaba (DashScope)**, **Kimi (Moonshot)**, **DeepSeek**, **Groq**, **OpenRouter**, **xAI (Grok)**, **OpenAI**, or **Other** (enter base URL + key). All use OpenAI-style `GET .../models` or `.../v1/models`. |
