#!/usr/bin/env bash
# Claudius v0.9.10 - Claude Code multi-backend bootstrapper (LM Studio, Ollama, llama.cpp server, OpenRouter, Custom, NewAPI).
...
Claudius v0.9.10 - Claude Code multi-backend bootstrapper
